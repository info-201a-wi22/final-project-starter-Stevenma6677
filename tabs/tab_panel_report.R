...
tab_panel_report <- tabPanel(
  ...
  h2("Project title"),
  p("Those secret stories about what Covid did on Economy"),
...
"),
  ...
  h2("Findings:"),
  p("From the data and graph we made we can find out that countries where worker hours decreased a lot normally have heavy covid-19 rate. And since workers lose a lot of working timw, they will face more and more financial problems."),
  
  h2("Discussion:"),
  p("Due to the decrease in worker's number, it is important for designers to think about how to manage existing resources to fulfill needs for jobs."),
  p("Companies need to start managing their plan for the future and strategies that make the economy run and make profits."),
  p("The data about the economy for covid can help the government to establish a better structure to overcome the problems and balance different areas' financial needs. At the same time, using this data can help technologists to develop a better application to manage the affected people."),
  
  h2("Conclusion"),
  p("The limitations we need to address are the methods in which data was collected and organized for our dataset, what biases could have affected the collection and organization to the data in our data set, and the limit of information in just a single data set. The ways we could overcome these is through adding in additional data sets to cross analyze this data through different lenses and perspectives. We could also do independent research and incorporate that by creating functions based on that research to analyze the data further."),
  
  h2("Acknowledgements"),
  p("Thanks Thomas for collecting the data form the data set and making the conclusion. And thanks Steven for editing the format of proposal."),
  
  h2("References:"),
  p("Covid-19 Racial and Ethnic Disparities. Centers for Disease Control and Prevention, Centers for Disease Control and Prevention"),
  a("Covid-19 Racial and Ethnic Disparities.", href = "https://www.cdc.gov/coronavirus/2019-ncov/community/health-equity/racial-ethnic-disparities/index.html"),
  
  p("Impact of Covid-19 on People's Livelihoods, Their Health and Our Food Systems.World Health Organization, World Health Organization"),
  a("Impact of Covid-19 on People's Livelihoods, Their Health and Our Food Systems.", href = "https://www.who.int/news/item/13-10-2020-impact-of-covid-19-on-people's-livelihoods-their-health-and-our-food-systems"),
  
  p("_Nirmita Panchal_, _Rabah Kamal_, and Feb 2021. The Implications of COVID-19 for Mental Health and Substance Use. KFF, 20 July 2021"),
  a("The Implications of COVID-19 for Mental Health and Substance Use.", href = "https://www.kff.org/coronavirus-covid-19/issue-brief/the-implications-of-covid-19-for-mental-health-and-substance-use/")
